...
$query="SELECT * from user WHERE user_type='Electrical' ORDER BY id DESC";
...
<div class="jumbotron bg-light">
  <nav class="navbar navbar-expand-sm bg-dark-subtle">
          <a class="navbar-brand" href="Laborpage.php">Electrical</a>
...
<div class="jumbotron bg-light">
        ...
        <p class="lead"> Welcome to Gharkakaam.com Information of Electrical in Your Location </p>
        <a class="btn btn-primary btn-lg" href="formsubmit.php?role=Electrical" role="application">Submit Your Profile
        </a>
