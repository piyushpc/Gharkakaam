...
$query="SELECT * from user WHERE user_type='Mistri' ORDER BY id DESC";
...
<div class="jumbotron bg-light">
  <nav class="navbar navbar-expand-sm bg-dark-subtle">
          <a class="navbar-brand" href="Mistri.php">Mistri</a>
...
<div class="jumbotron bg-light">
        ...
        <a class="btn btn-primary btn-lg" href="formsubmit.php?role=Mistri" role="application">Submit Your Profile
        </a>
