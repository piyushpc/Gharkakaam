...
$query="SELECT * from user WHERE user_type='plumber' ORDER BY id DESC";
...
<div class="jumbotron bg-light">
  <nav class="navbar navbar-expand-sm bg-dark-subtle">
          <a class="navbar-brand" href="Laborpage.php">plumber</a>
...
<div class="jumbotron bg-light">
       ...
       <!--  <p class="lead"> Welcome to Gharkakaam.com Information of plumber in Your Location </p>
        <a class="btn btn-primary btn-lg" href="formsubmit.php?role=plumber" role="application">Submit Your Profile
        </a>
      ...
      <?php while ($profile = mysqli_fetch_array($qu)) { ?>
        <div class="card mb-2" style="max-width: 940px;">
          ...
          <img src="<?php echo $profile['imgpath']; ?>"  class="img-fluid rounded-start" alt="Profile Image" style="max-width: 250px;">
            ...
            <span class="name mb-9 fw-400 "><large><?php echo $profile['name']; ?></large></span>
            <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
            ...
            <div class="location mt-7">&nbsp;&nbsp;
              ...
              <!-- <div class="location mt-6"> -->
                ...
                ?>
                <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  <a class="btn btn-success" id="callBtn" href="tel:<?php echo $profile['contact']; ?>">Call Now &nbsp;&nbsp;
