...
$query="SELECT * from user WHERE user_type='painter' ORDER BY id DESC";
...
<div class="jumbotron bg-light">
  <nav class="navbar navbar-expand-sm bg-dark-subtle">
          <a class="navbar-brand" href="Laborpage.php">painter</a>
...
<div class="jumbotron bg-light">
        ...
        <p class="lead"> Welcome to Gharkakaam.com Information of painter in Your Location </p>
        <a class="btn btn-primary btn-lg" href="formsubmit.php?role=painter" role="application">Submit Your Profile
        </a>
        ...
        <img src="img\newsmiling-young-builder-man-uniform-with-safety-helmet-holding-oil-paint-paint-roller-isolated-green-wall-with-copy-space.jpg" alt="" class="my-image3">
        </div>
