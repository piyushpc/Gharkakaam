...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmrYazlsa3Db44wrcCnA9KeYI_0c2l6yw&libraries=places"></script>
    ...
    <title>Painter | My Website</title>
...
<nav class="navbar navbar-expand-sm bg-dark-subtle">
	...
	<div class="popup" style="display: none;">
		<h5>Enter Your City to find your Nearest Painter</h5>
      ...
      <!-- <div class="jumbotron bg-light"> -->
        ...
        <div class="form-group">
          ...
          <span class="name mb-1 fw-100"><h3 class="display-7">Welecome To Gharkakaam </h3></span>
            <span class="name mb-1 fw-100"><h3 class="display-6">Active Painter in Your Location</h3></span>
            <br>
            <span class="name mb-9 fw-400 ">Enter your Address and find Your Nearest Painter In Your Location. </span>
