...
$query="SELECT * from user WHERE user_type='Architect' ORDER BY id DESC";
...
<div class="jumbotron bg-light">
  <nav class="navbar navbar-expand-sm bg-dark-subtle">
          <a class="navbar-brand" href="Architect.php">Architect</a>
...
<div class="jumbotron bg-light">
        ...
        <a class="btn btn-primary btn-lg" href="formsubmit.php?role=Architect" role="application">Submit Your Profile
        </a>
