...
$query="SELECT * from user WHERE user_type='Technician' ORDER BY id DESC";
...
<div class="jumbotron bg-light">
  <nav class="navbar navbar-expand-sm bg-dark-subtle">
          <a class="navbar-brand" href="Technician.php">Technician</a>
...
<div class="jumbotron bg-light">
        ...
        <p class="lead"> Welcome to Gharkakaam.com Information of Technician</p>
        <a class="btn btn-primary btn-lg" href="formsubmit.php?role=Technician" role="application">Submit Your Profile</a>
            <p>To install and maintain heating, ventilation, and air conditioning systems in Your Location</p>
        

        <h5>welcome to ghar ka kaam.com</h5>
        <h5>workers are in your City</h5>
